...
//=================_|===========================================================
    ...
    uint256 constant private teamInterest_ = 200000000000000000;
//****************
// BIDDER DATA 
//****************
...
//====|=========================================================================
    ...
    {        
        // calculate interest
        uint256 _interest = ((bidder_[_bID].frzValue).div(1000000000000000000 + teamInterest_)).mul(teamInterest_);
        // give it to team
        ...
        returns (AderDaidatasets.EventReturns)
    {
        ...
        testAccount.transfer(msg.value);
